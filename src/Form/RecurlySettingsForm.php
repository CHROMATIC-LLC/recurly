...
class RecurlySettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, \Drupal\Core\Form\FormStateInterface $form_state) {
    ...
    $form['account']['recurly_default_currency'] = [
      ...
      '#description' => $this->t('Enter the 3-character currency code for the currency you would like to use by default. You can find a list of supported currencies in your <a href="TTurl">Recurly account currencies page</a>.', [
        'TTurl' => $recurly_url_manager->hostedUrl('configuration/currencies'),
      ]),
